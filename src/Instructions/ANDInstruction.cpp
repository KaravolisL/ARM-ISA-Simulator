/////////////////////////////////
/// @file ANDInstruction.cpp
///
/// @brief Implementation for ANDInstruction
///
...
// C++ PROJECT INCLUDES
#include "ANDInstruction.hpp" // Header for class
#include "SLList.hpp" // For SLList
#include "Process.hpp" // For Process
#include "FileIterator.hpp" // For Io::FileIterator

////////////////////////////////
/// METHOD NAME: ANDInstruction::Execute 
////////////////////////////////
void ANDInstruction::Execute(const SLList<std::string>& rArguments, Process& rProcess, bool flagged)
{
